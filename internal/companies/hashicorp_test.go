...
func TestGetJobRequirementsHashicorp(t *testing.T) {
	expected := jobs.Job{
		Title:    "Site Reliability Engineer - Cloud Services",
		Type:     "Permanent",
		Salary:   "N/A",
	...
	result := h.getJobRequirements(elements[0])

	assert.Equal(t, expected.Requirements, result)
}

func TestGetJobLocationHashicorp(t *testing.T) {
	expected := jobs.Job{
		Title:    "Site Reliability Engineer - Cloud Services",
		Type:     "Permanent",
		Salary:   "N/A",
...
func TestGetJobTypeHashicorp(t *testing.T) {
	expected := jobs.Job{
		Title:    "Site Reliability Engineer - Cloud Services",
		Type:     "Permanent",
		Salary:   "N/A",
	...
	result := h.getJobType(nil)

	assert.Equal(t, expected.Type, result)
}

func TestGetJobURLHashicorp(t *testing.T) {
	logger, err := zap.NewDevelopment()
	defer logger.Sync()
	sugar := logger.Sugar()
	if err != nil {
...
func TestGetJobTitleHashicorp(t *testing.T) {
	expected := jobs.Job{
		Title:    "Site Reliability Engineer - Cloud Services",
		Type:     "Permanent",
		Salary:   "N/A",
	...
	result := h.getJobTitle(elements[0])

	assert.Equal(t, expected.Title, result)
}

func TestGetJobSalaryHashicorp(t *testing.T) {
	expected := jobs.Job{
		Title:    "Site Reliability Engineer - Cloud Services",
		Type:     "Permanent",
		Salary:   "N/A",
